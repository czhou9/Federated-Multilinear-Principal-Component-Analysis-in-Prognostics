function [U2]=incrementalSVD_localoptimization2(Signal,N_user1,P1,P3)


N=size(Signal,2);
%%%%%%%%%%Initinalization Using the First User's Data%%%%%%%%%%%%%%%%%%%%%%%%%
Ut=null(1);St=null(1);Vt=null(1);
FirstUser=Signal(:,1:(N_user1*P1*P3));%%%%%%%%%%%%%%
r = rank(FirstUser);%%%%%%%%%%%%%%
...
Signal=Signal(:,(N_user1*P1*P3+1):N);%%%%%%%%%%%%%%
for i=1:(N-N_user1*P1*P3)
    vt=Signal(:,i);
    %if i==1%%%%%%%%%%%%%%
        %rt=vt;%%%%%%%%%%%%%%
        %wt=null(1);%%%%%%%%%%%%%%
